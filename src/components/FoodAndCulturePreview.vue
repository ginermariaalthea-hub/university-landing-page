...
<template>
  <div class="page">
    ...
    <header class="hero">
      <div class="container">
        <p class="eyebrow">About Iloilo City</p>

        <h1>
          Where heritage, culture, food, and modern living come together.
          (THIS IS FOR CLASS WORK SAMPLE ONLY)
        </h1>

        <p class="lead">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          Architecto recusandae, nostrum cum maiores molestiae sed totam
          quam qui tempora placeat odio praesentium consequuntur enim nemo
          incidunt, voluptatum minus rerum ex!
        </p>
      </div>
    </header>
